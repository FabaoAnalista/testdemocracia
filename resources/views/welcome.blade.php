    ...
    <body>
      <!-- Navbar -->
        ...
        <header class="w3-container w3-blue w3-center" style="padding:70px 20px">
          ...
          <h1>Um sistema para projetos de iniciativa popular de João Monlevade.</h1>
          <h2>Assine um projeto de lei!!!!</h2>
          <h2>Um projeto de lei de iniciativa popular precisa atingir uma porcentagem mínima de assinaturas de eleitores para ser encaminhado e apresentado em uma classe legislativa</h2>
